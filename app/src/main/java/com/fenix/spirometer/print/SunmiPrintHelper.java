package com.fenix.spirometer.print;
...
public class SunmiPrintHelper {
    ...
    public void printExample(Context context){
        Log.d("print","========"+sunmiPrinterService);
        if(sunmiPrinterService == null){
            //TODO Service disconnection processing
            return ;
        }
        ...
        try {
            ...
            sunmiPrinterService.printText("肺活量标准测试报告\n", null);
            LinkedList<TableItem> datalist1=new LinkedList<>();
            String row[]={"姓名： 刘明","性别：男","身高： 174cm","年龄：58","体重8k：7g"};
            TableItem ti = new TableItem();
            ti.setText(row);
            datalist1.add(ti);

            for (TableItem tableItem : datalist1) {
                printTable(tableItem.getText(),
                        tableItem.getWidth(), tableItem.getAlign());
            }
            Bitmap bitmap1 = BitmapFactory.decodeResource(context.getResources(), R.drawable.default_image);
           // Bitmap bitmap2 = BitmapFactory.decodeResource(context.getResources(), R.drawable.testing2);
           // Bitmap bitmap3 = BitmapFactory.decodeResource(context.getResources(), R.drawable.testing3);
            sunmiPrinterService.printBitmap(bitmap1, null);
           // sunmiPrinterService.printBitmap(bitmap2, null);
            //sunmiPrinterService.printBitmap(bitmap3, null);
//            LinkedList<TableItem> datalist=new LinkedList<>();
//            String row[]={"test0","test1","test2"};
//            TableItem ti = new TableItem();
//            ti.setText(row);
//            datalist.add(ti);
//
...
//            }
            ...
            sunmiPrinterService.printText("肺年龄:"+"66.598\n", null);
            sunmiPrinterService.printText("动作规范:"+"中\n", null);
            sunmiPrinterService.printText("检查日期:"+ "2021.4.2\n", null);
            sunmiPrinterService.printText("操作人员:"+ "李晓楠\n", null);
